...
(defcustom i3-focus-move-bindings '((left . "Control+h")
                                    (right . "Control+l")
                                    (up . "Control+k")
                                    (down . "Control+j"))
  "The key bindings in i3 to move x-window focus."
...
(defconst i3-config-tag "# automatically generated by `i3-mode'")
...
(defun i3-update-config ()
  ...
  (with-temp-buffer
    ...
    (dolist (binding i3-focus-move-bindings)
      (insert (concat "bindsym " (cdr binding)
                      " exec --no-startup-id \"move-focus "
